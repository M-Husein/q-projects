...
(function (factory) {
    ...
    $h = {
        ...
        closeButton:function(css){
					...
					return '<button type="button" class="'+css+'" aria-label="Close" title="Clear / Cancel" tabindex="-1"><span aria-hidden="true">&times;</span></button>';
        }
    };
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings:{
                    ...
                    dragSettings: {},
                    indicatorNew: '<i class="glyphicon glyphicon-plus-sign text-warning R"></i>',
        ...
        _initClickable:function(){
            ...
            $zone.attr('tabindex',-1);
						//$zone.attr({tabindex:'-1',title:'Click to Browse'});
